...
Diablo is a low cost (<=7500 USD :) ) ROS2 enabled biped-wheeled robot capable of self-balancing and achieving various dynamic maneuvers.
...
There is a package called jointctrlsdk that has the script diablo_torque.cpp in the src directory.
# Build the package.
```bash
